...
public class SendOperation extends DcrComputationEvent {

    private final Set<String> receivers;

    SendOperation(String eventId, String action, String initiator, Set<String> receivers, ASTNode computationExpression,
    ...
    SendOperation(String eventId, SendOperation other) {
        super(other);
