...
import deprecated.pingpong.messages.PingMessage;
import deprecated.pingpong.messages.PongMessage;
...
public class PingPongProtocol extends GenericProtocol {
     ...
     */
    public void sendPingMessage(Host destination, String message, EventMarking marking) {
    ...
    public void uponReceivePingMessage(PingMessage msg, Host from, short sourceProto, int channelId) {
        ...
        DcrRequest request = new DcrRequest(msg.getMessage(), msg.getMarking(), from);
