package app1.protocols.dcr;

public class DCRProtocol {
  //       extends GenericProtocol {
  //
  //   public static final short PROTO_ID = 53; // unique protocol id
  //
  //   public static final int DEFAULT_PORT = 9000; // default port to listen on
  //   private static final Logger logger = LogManager.getLogger(DCRProtocol.class); // logger for the protocol
  //
  ...
  //               dcrRequest.getDestination(), dcrRequest.getEventId(), dcrRequest.getIdExtensionToken());
  ...
  //       sendPingMessage(dcrRequest.getDestination(), dcrRequest.getEventId(),
  //               dcrRequest.getMarking(), dcrRequest.getIdExtensionToken(), dcrRequest.getSender());
