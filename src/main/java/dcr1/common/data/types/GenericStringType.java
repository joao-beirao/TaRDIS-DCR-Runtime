 ...
 *
 */
public final class GenericStringType
        implements StringType, PrimitiveType {

    @Serial
    private static final long serialVersionUID = -1661775326115213130L;
    private static final GenericStringType INSTANCE = new GenericStringType();
    private static final String TO_STRING_VAL = "String";


    public static GenericStringType singleton() {return INSTANCE;}

    private GenericStringType() {}
